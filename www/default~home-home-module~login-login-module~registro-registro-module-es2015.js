...
let AuthService = class AuthService {
    constructor(AFauth, router, fb, google) {
        this.AFauth = AFauth;
        this.router = router;
        this.fb = fb;
        this.google = google;
    ...
    loginWithFacebook() {
        return this.fb.login(['email', 'public_profile']).then((response) => {
            const credential_fb = firebase__WEBPACK_IMPORTED_MODULE_6__["auth"].FacebookAuthProvider.credential(response.authResponse.accessToken);
    ...
    loginWithGoogle() {
        return this.google.login({}).then(result => {
            ...
            return this.AFauth.auth.signInWithCredential(firebase__WEBPACK_IMPORTED_MODULE_6__["auth"].GoogleAuthProvider.credential(null, user_data_google.accessToken));
        });
    }
};
...
//# sourceMappingURL=default~home-home-module~login-login-module~registro-registro-module-es2015.js.map