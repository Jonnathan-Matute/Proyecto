...
/***/ "./src/app/services/recordatorioservice.service.ts":
/*!*********************************************************!*\
  !*** ./src/app/services/recordatorioservice.service.ts ***!
  \*********************************************************/
/*! exports provided: RecordatorioserviceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RecordatorioserviceService", function() { return RecordatorioserviceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var RecordatorioserviceService = /** @class */ (function () {
    function RecordatorioserviceService(afs, geofence) {
        this.afs = afs;
    ...
    RecordatorioserviceService.prototype.saveRecordatorio = function (recordatorio) {
        ...
        var refRecordatorio = this.afs.collection("recordatorios");
    ...
    RecordatorioserviceService.prototype.ObtenerRecordatorio = function () {
    ...
    RecordatorioserviceService.prototype.getRecordatorio = function () {
        return this.afs.collection("recordatorios", function (ref) { return ref.where("deleted", "==", false); }).valueChanges();
    };
    ...
    RecordatorioserviceService.prototype.borrarRecor = function (uid) {
        console.log("esto hace al borrar");
        var refRecordatorio = this.afs.collection("recordatorios");
        var aux = { deleted: true };
        refRecordatorio.doc(uid).set(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, aux), { merge: true });
    };
    RecordatorioserviceService.prototype.addGeofence = function () {
