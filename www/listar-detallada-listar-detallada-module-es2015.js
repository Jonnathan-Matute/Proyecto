...
let ListarDetalladaPageRoutingModule = class ListarDetalladaPageRoutingModule {
};
...
let ListarDetalladaPageModule = class ListarDetalladaPageModule {
};
...
let ListaRecordatoriosService = class ListaRecordatoriosService {
    constructor(db) {
        this.db = db;
    }
};
ListaRecordatoriosService.ctorParameters = () => [
...
//# sourceMappingURL=listar-detallada-listar-detallada-module-es2015.js.map